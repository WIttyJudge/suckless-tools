...
static const unsigned int vertpadbar   = 8;        /* padding height to add to te status bar */
static const unsigned int horizpadbar  = 1;        /* padding width to add around text on the status bar */
