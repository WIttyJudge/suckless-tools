...
- [fuzzymatch](https://tools.suckless.org/dmenu/patches/fuzzymatch/) – Supports fuzzy-find.
...
- [scrollback-mouse](https://st.suckless.org/patches/scrollback/) - Adds the ability to scroll with SHIFT+MouseWheel.
- [scrollback](https://st.suckless.org/patches/scrollback/) - Adds scrollback with SHIFT+PageUp/PageDown.
- [Clipboard](https://st.suckless.org/patches/clipboard/) - This patch makes st set CLIPBOARD on selection.
- [alpha](https://st.suckless.org/patches/alpha/) - Adds opacity to the background (must have a compositor for this to work).
- [Boxdraw](https://st.suckless.org/patches/boxdraw/) - adds dustom rendering of lines/blocks/braille characters for gapless alignment.
- patch_column ( doesnt cut text while resizing)
- [font2](https://st.suckless.org/patches/font2/) - Adds the option to list multiple fonts.
- right click paste
- [st desktop entry](https://st.suckless.org/patches/desktopentry/) - Can be displayed with an icon when using a graphical launcher.
- newterm
- [anygeometry](https://st.suckless.org/patches/anygeometry/) - Adds the ability to configure st via Xresources.
- [xresources](https://st.suckless.org/patches/xresources/) - Adds the ability to configure st via Xresources.
